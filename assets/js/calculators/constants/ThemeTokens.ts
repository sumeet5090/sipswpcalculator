...
export const DEFAULT_THEME_COLORS: ThemeColorsSchema = {
    ...
    chart: {
        ...
        gradientInvestedTop: 'rgba(99, 102, 241, 0.16)',
        gradientInvestedMid: 'rgba(99, 102, 241, 0.04)',
        gradientInvestedBottom: 'rgba(99, 102, 241, 0.0)',
        gradientCorpusTop: 'rgba(16, 185, 129, 0.25)',
        gradientCorpusMid: 'rgba(16, 185, 129, 0.06)',
        gradientCorpusBottom: 'rgba(16, 185, 129, 0.0)',
        gradientPostTaxTop: 'rgba(139, 92, 246, 0.20)',
        gradientPostTaxMid: 'rgba(139, 92, 246, 0.04)',
        gradientPostTaxBottom: 'rgba(139, 92, 246, 0.0)',
        swpFillBg: 'rgba(244, 63, 94, 0.08)',
        milestoneLineActive: 'rgba(16, 185, 129, 0.50)',
        milestoneLineSubtle: 'rgba(16, 185, 129, 0.20)',
    },
    celebration: [
        '#10b981',
        '#059669',
