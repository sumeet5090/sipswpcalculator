...
Complete 2026 guide to mutual fund taxation
...
<div class="bg-slate-900 text-white p-10 rounded-3xl text-center my-14 not-prose border border-slate-800 shadow-2xl overflow-hidden relative">
    ...
    <div class="relative z-10">
        <h3 class="text-2xl font-bold mb-4 text-white">Model Your Post-Tax Wealth</h3>
        <p class="mb-8 text-slate-400 text-lg max-w-2xl mx-auto">Our calculator automatically accounts for these tax brackets to give you a realistic "Spendable Income" projection.</p>
