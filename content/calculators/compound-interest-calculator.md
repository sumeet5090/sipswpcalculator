...
<div class="mt-12 not-prose rounded-3xl overflow-hidden border border-emerald-100 shadow-xl bg-gradient-to-br from-emerald-600 to-teal-700 p-8 sm:p-10 text-center text-white">
  <h2 class="text-2xl sm:text-3xl font-extrabold mb-3 tracking-tight">See Compound Interest Work For You</h2>
  <p class="text-emerald-100 mb-7 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">Compound interest is even more powerful with monthly SIPs. Model step-up SIP growth and plan your retirement withdrawal — all in one free tool.</p>
