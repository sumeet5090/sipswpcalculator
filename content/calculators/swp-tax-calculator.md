...
<div class="mt-12 not-prose rounded-3xl overflow-hidden border border-rose-100 shadow-xl bg-gradient-to-br from-rose-600 to-rose-800 p-8 sm:p-10 text-center text-white">
  <h2 class="text-2xl sm:text-3xl font-extrabold mb-3 tracking-tight">Calculate Your SWP Tax Now</h2>
  <p class="text-rose-100 mb-7 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">Simulate SWP withdrawals from your mutual fund corpus and estimate exact capital gains tax across different holding periods.</p>
