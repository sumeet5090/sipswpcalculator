...
<div class="mt-12 p-8 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-2xl text-white shadow-xl text-center not-prose">
<h2 class="text-2xl font-bold mb-4 text-white">Calculate Your SWP Income Now</h2>
<p class="mb-8 text-purple-100">Model your retirement withdrawals with step-up inflation protection, separate return rates, and see exactly how long your corpus will last.</p>
<a href="/#calculator-section" class="inline-flex items-center px-8 py-3 bg-white text-purple-600 font-bold rounded-lg shadow-lg hover:bg-gray-50 transform hover:-translate-y-1 transition-all duration-200">
