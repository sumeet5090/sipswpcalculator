...
title: "FD Calculator India — Fixed Deposit Interest Planner"
...
meta_desc: "Calculate bank Fixed Deposit (FD) interest with quarterly compounding, senior citizen rate bonuses, and post-tax yields under Section 194A TDS. Free chart & table."
keywords: "fd calculator, fixed deposit calculator, bank fd calculator india, quarterly compounding fd, senior citizen fd calculator, sbi fd calculator, post-tax fd yield"
schema_name: "FD Calculator India — Fixed Deposit Maturity Planner"
seo_category: "growth"
type: "calculator"
date: "2026-09-01"
---
...
*   **Quarterly Payout:** The simplest non-cumulative structure. The bank pays simple interest every three months:
    $$\text{Quarterly Payout} = P \times \left(\frac{r}{400}\right)$$
*   **Monthly Payout (Discounted Under RBI Rules):** Because interest is paid out before completing a full quarter, RBI mandates a **discounted monthly rate** rather than a simple $r/12$ division. The formula ensures mathematical parity with quarterly compounding:
    $$\mathbf{\text{Monthly Payout} = P \cdot \left[ \left(1 + \frac{r}{400}\right)^{\frac{1}{3}} - 1 \right]}$$
...
1. **Senior Citizens (Aged 60 to 79 Years):** Eligible for an additional **+0.50% p.a.** over and above the standard card rate across virtually all tenures.
2. **Super Senior Citizens (Aged 80 Years and Above):** Specialized public and private sector banks (e.g., Punjab National Bank, RBL Bank, Union Bank of India) offer an enhanced bonus of **+0.75% to +0.80% p.a.**
3. **Special Fixed Deposit Schemes:** Programs like SBI WeCare, HDFC Senior Citizen Care, and ICICI Golden Years offer further promotional spreads (+0.75% to +1.00%) on tenures of 5 to 10 years.
...
1. **Deposit Amount (Principal):** Enter the lump sum capital you plan to place in the fixed deposit.
2. **Annual Interest Rate (%):** Enter the interest rate offered by your bank for your chosen tenure.
3. **Tenure (Years):** Specify your deposit horizon (supports fractions, such as `1.5` for 18 months).
