...
<body class="bg-gray-50 text-gray-800 font-sans antialiased"
    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <main
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-sm font-bold text-slate-500"
                                    id="ci-symbol"><span class="currency-text">$</span></span>
                    ...
                    <div id="ci-results" class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                        <div class="bg-indigo-50 p-4 rounded-xl text-center border border-indigo-100">
                            <div class="text-[10px] font-bold text-indigo-600 uppercase tracking-widest mb-1">Final
                                Amount</div>
                            <div id="ci-final" class="text-xl font-extrabold text-indigo-700 font-mono"><span class="currency-text">$</span>2,15,892
                            </div>
                        </div>
                        <div class="bg-emerald-50 p-4 rounded-xl text-center border border-emerald-100">
                            <div class="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-1">Interest
                                Earned</div>
                            <div id="ci-interest" class="text-xl font-extrabold text-emerald-600 font-mono"><span class="currency-text">$</span>1,15,892
                            </div>
                        </div>
            ...
            <div class="not-prose overflow-x-auto mb-6">
                <table class="w-full text-sm border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-4 py-3 border border-slate-200 font-medium"><span class="currency-text">$</span>1L at 10% for 20 years</td>
                            <td class="px-4 py-3 border border-slate-200 text-emerald-700 font-bold"><span class="currency-text">$</span>6,72,750</td>
                            <td class="px-4 py-3 border border-slate-200"><span class="currency-text">$</span>3,00,000</td>
                        </tr>
                        <tr class="bg-slate-50/50">
                            <td class="px-4 py-3 border border-slate-200 font-medium"><span class="currency-text">$</span>10K at 8% for 30 years</td>
                            <td class="px-4 py-3 border border-slate-200 text-emerald-700 font-bold"><span class="currency-text">$</span>100,627</td>
                            <td class="px-4 py-3 border border-slate-200"><span class="currency-text">$</span>34,000</td>
                        </tr>
                        <tr>
            ...
            <p>The more frequently interest is compounded, the more you earn. Here's a comparison for a <span class="currency-text">$</span>1,000
                ...
                <table class="w-full text-sm border-collapse">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono"><span class="currency-text">$</span>2,59,374</td>
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono text-emerald-600">
                                <span class="currency-text">$</span>1,59,374</td>
                        </tr>
                        <tr class="bg-slate-50/50">
                            <td class="px-4 py-3 border border-slate-200">Quarterly (n=4)</td>
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono"><span class="currency-text">$</span>2,68,506</td>
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono text-emerald-600">
                                <span class="currency-text">$</span>1,68,506</td>
                        </tr>
                        <tr>
                            ...
                            <td
                                ...
                                <span class="currency-text">$</span>2,70,704</td>
                            <td
                                class="px-4 py-3 border border-slate-200 text-right font-mono text-emerald-600 font-bold">
                                <span class="currency-text">$</span>1,70,704</td>
                        </tr>
                        <tr class="bg-slate-50/50">
                            <td class="px-4 py-3 border border-slate-200">Daily (n=365)</td>
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono"><span class="currency-text">$</span>2,71,791</td>
                            <td class="px-4 py-3 border border-slate-200 text-right font-mono text-emerald-600">
                                <span class="currency-text">$</span>1,71,791</td>
                        </tr>
                    </tbody>
                </table>
            </div>
