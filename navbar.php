            ...
            <div class="relative nav-dropdown">
                ...
                <div class="absolute right-0 top-full pt-2 z-50 nav-dropdown-menu" style="min-width: 260px;">
                    <div class="bg-white rounded-xl shadow-xl border border-slate-200 py-2">
                        <a href="/sip-calculator" class="block px-6 py-2.5 text-sm text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 transition-colors whitespace-nowrap">SIP Guide</a>
    ...
    <div id="mobile-menu" class="sm:hidden hidden border-t border-slate-200 bg-white/95 backdrop-blur-md">
        <div class="px-4 py-3 space-y-1">
            ...
            <div id="mobile-guides-menu" class="hidden pl-4 pr-2 py-1 space-y-1 bg-slate-50/50 rounded-lg">
                <a href="/sip-calculator" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SIP Guide</a>
                <a href="/sip-step-up-calculator" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">Step-Up SIP Guide</a>
                <a href="/swp-retirement-planning" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SWP Retirement Planning</a>
                <a href="/mutual-fund-tax-2026" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">Mutual Fund Tax 2026</a>
                <a href="/sip-vs-fd-vs-ppf" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SIP vs FD vs PPF</a>
                <a href="/swp-tax-calculator" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SWP Tax Calculator</a>
                <a href="/compound-interest-calculator" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">Compound Interest Calculator</a>
                <a href="/swp-vs-fixed-deposit" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SWP vs Fixed Deposit</a>
                <a href="/sip-for-beginners" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">SIP for Beginners</a>
                <a href="/inflation-impact-on-sip" class="block px-3 py-2.5 rounded-lg text-sm text-slate-600 hover:text-indigo-600 hover:bg-slate-100 transition-colors">Inflation Impact on SIP</a>
            </div>
