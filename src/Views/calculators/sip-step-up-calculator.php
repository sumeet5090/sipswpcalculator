            ...
            <article
                ...
                <p>A <dfn><strong>Step-Up SIP</strong></dfn> (also called Top-Up SIP) is a variation of a regular SIP
                    where you <strong>automatically increase your monthly investment amount by a fixed percentage every
                        year</strong>. For example, if you start with <span class="currency-text">$</span>100/month and set a 10% annual step-up, your
                    SIP increases to <span class="currency-text">$</span>11,000 in Year 2, <span class="currency-text">$</span>12,100 in Year 3, and so on.</p>
                ...
                <p>The difference is dramatic. Here's a comparison assuming <span class="currency-text">$</span>100/month starting SIP at 12% annual
                ...
                <h3>Conservative: <span class="currency-text">$</span>50/month, 5% step-up, 20 years @ 12%</h3>
                <ul>
                    <li>Total Invested: <span class="currency-text">$</span>19.84 L</li>
                    <li>Maturity Value: <strong><span class="currency-text">$</span>1.09 Cr</strong></li>
                    <li>vs Flat SIP: <span class="currency-text">$</span>49.96 L (+<span class="currency-text">$</span>59 L gain from step-up alone)</li>
                </ul>

                <h3>Moderate: <span class="currency-text">$</span>100/month, 10% step-up, 20 years @ 12%</h3>
                <ul>
                    <li>Total Invested: <span class="currency-text">$</span>68.73 L</li>
                    <li>Maturity Value: <strong><span class="currency-text">$</span>3.54 Cr</strong></li>
                    <li>vs Flat SIP: <span class="currency-text">$</span>99.92 L (+<span class="currency-text">$</span>2.54 Cr gain from step-up alone)</li>
                </ul>

                <h3>Aggressive: <span class="currency-text">$</span>150/month, 15% step-up, 25 years @ 14%</h3>
                <ul>
                    <li>Total Invested: <span class="currency-text">$</span>2.94 Cr</li>
                    <li>Maturity Value: <strong><span class="currency-text">$</span>24.8 Cr</strong></li>
                ...
                <details class="group">
                    <summary class="cursor-pointer font-bold text-slate-800 py-2">Can I combine step-up SIP with step-up
                        SWP?</summary>
                    <div class="pb-4 text-gray-600">Yes! Our <a href="/#calculator-section" class="text-indigo-600 hover:underline">SIP &
