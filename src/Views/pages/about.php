...
<?php
$page_config = [
    'title' => 'About Me | SIP & SWP Calculator',
    ...
    <div class="profile-wrapper p-6 bg-white rounded-2xl border border-slate-200 mb-10">
        <a href="https://www.linkedin.com/in/sumeet-boga/" target="_blank" rel="noopener" class="flex-shrink-0">
            <img src="/assets/sumeet-boga.jpg" alt="Sumeet Boga — Creator of SIP & SWP Calculator"
                class="profile-img rounded-full object-cover border-2 border-emerald-100 shadow-sm" width="112"
                height="112">
        </a>
        <div>
        ...
        <div class="feature-grid">
            ...
            <div class="flex gap-4 p-4 bg-white rounded-xl border border-slate-200">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">One of the few calculators that model annual
                        step-up SIPs — how real investors actually invest as their income grows.</p>
                </div>
            </div>
            ...
            <div class="flex gap-4 p-4 bg-white rounded-xl border border-slate-200">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">Seamlessly model both the accumulation phase (SIP)
                        and the distribution phase (SWP) in a single simulation.</p>
                </div>
            </div>
            ...
            <div class="flex gap-4 p-4 bg-white rounded-xl border border-slate-200">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">Adjust withdrawals for inflation with annual
            ...
            <div class="flex gap-4 p-4 bg-white rounded-xl border border-slate-200">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 leading-relaxed">No account required, no data collection, no ads.
                        Your financial data stays securely in your browser.</p>
                </div>
            </div>
    ...
    <section class="mb-10">
        ...
        <div class="feature-grid">
            ...
            <div class="p-5 bg-white rounded-xl border border-slate-200">
                ...
                <p class="text-xs text-slate-500 mb-3">All financial data, tax rates, and formulas are verified against
                    official sources:</p>
                <ul class="text-xs text-slate-500 space-y-1.5 font-medium">
                    <li>• <a href="https://www.amfiindia.com/" target="_blank" rel="noopener noreferrer"
                            class="text-emerald-600 hover:underline">AMFI India</a></li>
                    <li>• <a href="https://www.sebi.gov.in/" target="_blank" rel="noopener noreferrer"
                            class="text-emerald-600 hover:underline">SEBI</a></li>
                    <li>• <a href="https://incometaxindia.gov.in/" target="_blank" rel="noopener noreferrer"
                            class="text-emerald-600 hover:underline">Income Tax India</a></li>
                </ul>
                <p
                    class="text-xs text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg inline-block font-semibold mt-3">
            ...
            <div class="p-5 bg-white rounded-xl border border-slate-200">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">
                    This calculator is for <strong class="text-slate-700">educational and illustrative purposes
                        only</strong>.
                    Projections do not account for exit loads, expense ratios, or extreme market volatility.
                    We are not registered financial advisors. Please consult a SEBI-registered advisor before making
                    investment decisions.
                </p>
                <div class="mt-4 pt-3 border-t border-slate-100">
                    <p class="text-xs text-slate-500">Contact: <a href="mailto:help@sipswpcalculator.com"
                            class="text-emerald-600 hover:underline font-medium">help@sipswpcalculator.com</a></p>
                </div>
            </div>
