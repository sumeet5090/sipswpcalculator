...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
    <!-- Post 1 -->
    <a href="/resource/20-year-wealth-blueprint-step-up-sip" class="group block p-6 rounded-2xl border border-slate-100 hover:border-indigo-100 hover:bg-indigo-50/30 transition-all shadow-sm">
    ...
    <!-- Post 2 -->
    <a href="/resource/retirement-planning-4-percent-swp-rule" class="group block p-6 rounded-2xl border border-slate-100 hover:border-indigo-100 hover:bg-indigo-50/30 transition-all shadow-sm">
    ...
    <!-- Post 3 -->
    <a href="/resource/sip-vs-swp-wealth-creation-withdrawal-strategy" class="group block p-6 rounded-2xl border border-slate-100 hover:border-indigo-100 hover:bg-indigo-50/30 transition-all shadow-sm">
