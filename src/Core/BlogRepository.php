...
class BlogRepository {
    ...
    public static function getAllPosts(): array {
        return [
            ...
            ['category' => 'growth', 'id' => 'growth', 'tag' => 'Blueprint', 'tag_color' => 'emerald', 'title' => 'Earning a Moderate Income in Your 20s? Here is Your Wealth Creation Blueprint', 'desc' => 'A step-by-step financial plan to start investing for long-term compounding, allocate across SIPs, emergency funds, and leverage the power of starting early.', 'href' => '/resource/growth/earning-moderate-income-in-20s-investment-blueprint', 'read_time' => '10 min', 'date' => 'July 2026'],
            ...
            ['category' => 'comparison', 'id' => 'comparison', 'tag' => 'Benchmarks', 'tag_color' => 'amber', 'title' => 'Mutual Fund Returns Benchmarks 2026', 'desc' => 'Historical benchmark tables for India, USA, UK, and EU. Learn how to select a realistic return rate for your planning.', 'href' => '/resource/comparison/mf-returns-benchmarks', 'read_time' => '9 min', 'date' => 'January 2026'],
        ];
    }
}
