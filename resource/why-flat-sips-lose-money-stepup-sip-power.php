...
<ul class="list-disc pl-6 mb-6 space-y-4">
    <li><strong>Final <a href="/resources.php#corpus" class="text-indigo-600 hover:underline">Corpus</a>:</strong> Approximately <strong>$989,000</strong>.</li>
</ul>
<p class="mb-6">Now, if you increase your SIP by just 10% each year (a "<a href="/resources.php#step-up-sip" class="text-indigo-600 hover:underline">Step-Up</a>"):</p>
<ul class="list-disc pl-6 mb-6 space-y-4">
    <li><strong>Final <a href="/resources.php#corpus" class="text-indigo-600 hover:underline">Corpus</a>:</strong> Approximately <strong>$2,100,000</strong>.</li>
</ul>
...
<ul class="list-disc pl-6 mb-6 space-y-4">
    ...
    <li><strong>Model Your Growth:</strong> Use a calculator that supports annual step-ups to see exactly how your <a href="/resources.php#corpus" class="text-indigo-600 hover:underline">corpus</a> will grow.</li>
</ul>
