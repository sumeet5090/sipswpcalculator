...
$page_content = '
<p class="text-xl mb-6">The transition from building your wealth to spending it is the most critical phase of your financial life. The <a href="/resources.php#four-percent-rule" class="text-indigo-600 hover:underline">4% SWP Rule</a> is a time-tested strategy to ensure your money lasts as long as you do.</p>

<h2 class="text-2xl font-bold mt-8 mb-4">What is the 4% Rule?</h2>
<p class="mb-6">First derived from the "Trinity Study," the 4% rule suggests that if you withdraw 4% of your total retirement <a href="/resources.php#corpus" class="text-indigo-600 hover:underline">corpus</a> in the first year and adjust that amount for inflation thereafter, your portfolio has a high probability of lasting at least 30 years.</p>
...
<p class="mb-6">If your 20-year SIP journey results in a $1 million <a href="/resources.php#corpus" class="text-indigo-600 hover:underline">corpus</a>, the 4% rule would allow for an annual withdrawal of $40,000, or about <strong>$3,333 per month</strong>. Using an SWP, you can automate this withdrawal directly from your mutual fund holdings.</p>
